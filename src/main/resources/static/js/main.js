document.addEventListener('DOMContentLoaded', function () {
    const apiKey = decodeURIComponent('UGjUbRmMr9bJY8Tci78aC0AVEGWH9%2FQun5rvOBAfnM1xO2R8FELXphXrc6sON2CHPq5V0EhxzCi%2FueCRfs3aRg%3D%3D'); // 디코딩된 TourAPI 키
        ...
        try {
            const response = await axios.get(apiUrl, {
                params: {
                    ...
                    contentTypeId: 12,
                    areaCode: getRandomAreaCode(), // 랜덤 지역 코드
                    showflag: 1,
                    _type: 'Json'
                },
            });
